...
```{r}
ggplot(centro_america, aes(x = name_long, y = lifeExp)) +   ggtitle('Esperanza de vida en Centroamerica') +
xlab('Paises') +
...
```{r}
plot(centro_america["lifeExp"], main="Esperanza de vida en Centroamerica")
```
...
```{r}
centro_america1 = world[world$name_long == "Nicaragua"| world$name_long == "Costa Rica" | world$name_long == "Panama" , ]
plot(centro_america1["lifeExp"], main="Esperanza de vida sobre los 74 en Centroamerica")
```